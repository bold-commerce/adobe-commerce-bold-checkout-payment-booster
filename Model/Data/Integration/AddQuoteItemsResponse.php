 ...
 */
class AddQuoteItemsResponse implements AddQuoteItemsResponseInterface
{
    /**
     ...
     */
    public function setData(mixed $data): AddQuoteItemsResponseInterface
    {
        $this->data = $data;
        return $this;
    }
     ...
     * @return \Bold\CheckoutPaymentBooster\Api\Data\Integration\AddQuoteItemsResponseInterface
     */
    public function setErrors(array $errors): AddQuoteItemsResponseInterface
    {
        $this->errors = $errors;
        return $this;
    }
     ...
     * @return \Bold\CheckoutPaymentBooster\Api\Data\Integration\AddQuoteItemsResponseInterface
     */
    public function addError(\Bold\CheckoutPaymentBooster\Api\Data\Integration\ErrorDataInterface $error): AddQuoteItemsResponseInterface
    {
     ...
     * @return \Bold\CheckoutPaymentBooster\Api\Data\Integration\AddQuoteItemsResponseInterface
     */
    public function addErrorWithMessage(string $message): AddQuoteItemsResponseInterface
    {
     ...
     * @return \Bold\CheckoutPaymentBooster\Api\Data\Integration\AddQuoteItemsResponseInterface
     */
    public function setResponseHttpStatus(int $code): AddQuoteItemsResponseInterface
    {
