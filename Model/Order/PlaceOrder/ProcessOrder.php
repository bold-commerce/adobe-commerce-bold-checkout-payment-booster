...
namespace Bold\CheckoutPaymentBooster\Model\Order\PlaceOrder;

use Bold\Checkout\Api\Data\PlaceOrder\Request\OrderDataInterface;
use Bold\Checkout\Model\Order\OrderExtensionData;
use Bold\Checkout\Model\Order\OrderExtensionDataFactory;
use Bold\Checkout\Model\Order\PlaceOrder\AddCommentsToOrder;
...
/**
 * Process order in case of payment-booster checkout.
 */
class ProcessOrder
{
    /**
