...
class ExpressPay implements ArgumentInterface
{
    ...
    public function getJsLayout()
    {
        ...
        if($quoteId !== null) {
           ...
           $this->jsLayout['checkoutConfig']['checkoutAgreements']['isEnabled'] = false;
           $this->jsLayout['checkoutConfig']['defaultSuccessPageUrl'] = $this->getDefaultSuccessPageUrl();
           $this->jsLayout['checkoutConfig']['shippingPolicy'] = $this->getShippingPolicy();
        }
