...
class BoldIntegration
{
    private const API_RESOURCES = [
        'Bold_CheckoutPaymentBooster::integration',
        'Bold_CheckoutPaymentBooster::secret_create',
    ...
    private const INTEGRATION_NAME_TEMPLATE = 'PaymentBoosterIntegration{{websiteId}}';
